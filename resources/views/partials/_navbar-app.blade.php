<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        ...
        <a
            ...
            href="{{ route('dashboard') }}"
        ><img
                src="{{ asset('icon/zen-mini-transparent.png') }}"
                alt="logo"
                style="object-fit: cover;"
            /></a>
        <button
                ...
                >
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img
                                src="{{ asset('celestial/template') }}/images/faces/face4.jpg"
                                alt="image"
                                class="profile-pic"
                            >
                        </div>
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img
                                src="{{ asset('celestial/template') }}/images/faces/face2.jpg"
                                alt="image"
                                class="profile-pic"
                            >
                        </div>
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img
                                src="{{ asset('celestial/template') }}/images/faces/face3.jpg"
                                alt="image"
                                class="profile-pic"
                            >
                        </div>
